    ...
    <VStack minW={'full'} align={'flex-start'} spacing={'10'}>
      <Box>
        <Text>
          ...
          <Text>
            This means the submitted query or compound could be elicit
            anti-dengue properties, and the model is 0.85 (out of 1.0) confident
            with its prediction
          </Text>
          <Text style={{ fontWeight: 'bolder', marginTop: '10px' }}>
          ...
          <Text>
            Yes, there are. The model is limited to the chemical space defined
            by its training dataset. As we train the model on bigger datasets,
            we hope to expand the domain of the model.
          </Text>
          <Text style={{ fontWeight: 'bolder', marginTop: '10px' }}>
          ...
          <Text>
            Please send complaints via the contact form(link to contact page){' '}
          </Text>
